...
# Load trained model
loaded_model = pickle.load(open('C:/Users/Admin/OneDrive/Desktop/acadX/1 AIML and Data Science/Machine Learning Siddharth Course/CAD App Deployment Streamlit/trained_model.sav', 'rb'))
